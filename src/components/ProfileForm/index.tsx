        ...
        <div className='mx-auto mt-8 grid'>
          ...
          <form
            ...
            <div className='flex justify-end'>
              <button
                type='submit'
                className='w-full rounded-full  bg-indigo-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-indigo-800 focus:outline-none focus:ring-4 focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 sm:w-auto'>
