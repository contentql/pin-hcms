...
export function ThreeDCardDemo({ item }: { item: Blog }) {
  return (
    <CardContainer className='inter-var'>
      <CardBody className='group/card relative h-auto rounded-xl  border border-black/[0.1] bg-gray-50 p-6 dark:border-white/[0.2] dark:bg-transparent dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] sm:w-[100%] sm:min-w-full md:w-auto  '>
