...
export type BlogsData = Omit<Blog, 'id' | 'createdAt' | 'updatedAt'>[]

export type BlogsImagesData = { data: { alt: string }; filePath: string }[]

export type BlogPageData = Omit<Page, 'id' | 'createdAt' | 'updatedAt'>
...
export const blogsImagesData: BlogsImagesData = [
  {
