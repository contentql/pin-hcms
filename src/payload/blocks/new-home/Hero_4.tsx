        ...
        <div className='grid grid-cols-1 items-center gap-12 sm:gap-20 md:grid-cols-2'>
          ...
          <div className='max-w-[720px] lg:max-w-[842px]'>
            <h1 className='mb-4 text-4xl font-semibold text-white md:text-6xl'>
              ...
              <span className="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')] bg-cover bg-center px-4 text-black">
                Dev Time
              </span>
            </h1>
            <p className='mb-6 max-w-[528px] text-xl text-white md:mb-10 lg:mb-12'>
