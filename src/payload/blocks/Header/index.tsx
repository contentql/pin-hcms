...
function Navbar({
  ...
  return (
    ...
    >
      <div className='boder shadow-input relative flex items-center justify-between rounded-full border-transparent bg-white px-5 dark:border-white/[0.2] dark:bg-black'>
        <div>
          <Image
